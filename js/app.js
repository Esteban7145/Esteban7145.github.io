const TYPES = {
    ...
    function initIpucPlatform() {
      ...
      if ("serviceWorker" in navigator) navigator.serviceWorker.register("/service-worker.js?v=20260909-mobile-menu-2").catch(() => {});
      setupSiteLoader();
      setupChurchMusic();
      loadDriveMusic();
    ...
    function installPlatformStyles() {
      ...
      link.rel = "stylesheet";
      link.href = "/css/platform-runtime.css?v=20260909-mobile-menu-2";

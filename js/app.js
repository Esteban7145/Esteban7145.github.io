const TYPES = {
    ...
    function installPlatformStyles() {
      ...
      style.textContent = `
        ...
        .hero-copy .home-hero-title { display: block; max-width: 1080px; color: transparent; font-family: "Trebuchet MS", "Segoe UI", Arial, sans-serif; font-size: clamp(3.15rem, 7.2vw, 7.6rem); font-style: normal; font-weight: 900; letter-spacing: -.07em; line-height: .9; text-wrap: balance; perspective: 900px; text-shadow: 0 1px 0 rgba(255,255,255,.78), 0 9px 18px rgba(11,52,72,.14); }
